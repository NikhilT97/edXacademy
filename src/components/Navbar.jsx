      ...
      <nav className="bg-white shadow-md border-b border-gray-100 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-2 rounded-xl mr-3 shadow-md">
            ...
            <div className="hidden md:flex items-center space-x-4">
              {state.auth.isAuthenticated ? (
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-3">
                    <img
                      ...
                      className="h-8 w-8 rounded-full ring-2 ring-blue-500 ring-offset-2 shadow-sm"
                    />
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2 rounded-xl font-medium hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg"
                >
                  Sign In
                </button>
              )}
                ...
                {state.auth.isAuthenticated ? (
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-3 rounded-xl font-medium hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-md"
                    >
                      Sign In
                    </button>
                  </div>
