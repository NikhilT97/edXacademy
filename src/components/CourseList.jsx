...
export default function CourseList({ setCurrentView, setSelectedCourse }) {
  ...
  useEffect(() => {
    let filtered = state.courses.filter(course => {
      ...
      const matchesDifficulty =
        state.filters.difficulty === 'All Levels' ||
        course.difficulty === state.filters.difficulty;

      const matchesPrice =
        course.price >= state.filters.minPrice &&
  ...
  const handleSortChange = field => {
    // Always set field and reset direction to asc
    dispatch({
      type: 'SET_SORT',
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center">
            ...
            <div className="flex gap-3 items-center">
              <select
                ...
                className="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white transition"
              >
              ...
              <button
                ...
                className="px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-700 hover:bg-gray-100 transition"
              >
          ...
          {showFilters && (
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      dispatch({
                        type: 'SET_FILTERS',
                        payload: { difficulty: e.target.value },
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  >
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Price Range: ${state.filters.minPrice} - $
                  ...
                  <input
                    ...
                    onChange={e =>
                      dispatch({
                        type: 'SET_FILTERS',
                        payload: { maxPrice: parseInt(e.target.value) },
                      })
                    }
          ...
          {state.auth.isAuthenticated &&
            state.auth.user?.role === 'instructor' && (
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition shadow-md hover:shadow-lg"
              >
                Add New Course
              </button>
            )}
        ...
        {totalPages > 1 && (
          <div className="flex justify-center items-center space-x-2">
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition"
            >
