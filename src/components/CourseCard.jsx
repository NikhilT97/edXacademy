    ...
    <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden group">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-4 left-4">
          <span
            className={`px-3 py-1 rounded-full text-sm font-medium shadow-md ${getDifficultyColor(
              course.difficulty
            )}`}
          >
            {course.difficulty}
        ...
        <div className="absolute top-4 right-4">
          <span className="bg-white bg-opacity-90 text-blue-600 px-3 py-1 rounded-full text-sm font-medium shadow-md">
            {course.category}
          </span>
        </div>
        ...
        {isOwnCourse && (
          <div className="absolute bottom-4 right-4 flex space-x-2">
            <button
              ...
              className="p-2 bg-white bg-opacity-90 text-blue-600 rounded-full hover:bg-blue-600 hover:text-white transition-colors duration-200 shadow-md"
            >
              <Edit className="h-4 w-4" />
            </button>
            <button
              onClick={handleDelete}
              className="p-2 bg-white bg-opacity-90 text-red-600 rounded-full hover:bg-red-600 hover:text-white transition-colors duration-200 shadow-md"
            >
      ...
      <div className="p-6">
        ...
        <div className="flex items-center mb-4">
          <div className="w-9 h-9 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center mr-3 shadow-md">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
          ...
          <div className="flex space-x-2">
            <button
              ...
              className="px-4 py-2 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors duration-200 text-sm font-medium shadow-sm"
            >
              Details
            </button>
