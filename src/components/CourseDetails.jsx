            ...
            <div className="lg:col-span-2">
              <div className="mb-6">
                ...
                <div className="flex items-center space-x-3 mb-4">
                  <span
                    className={`px-3 py-1 rounded-full text-sm font-medium border shadow-sm ${getDifficultyColor(
                      course.difficulty
                    )}`}
                  >
                    {course.difficulty}
                  </span>
                  <span className="bg-blue-50 text-blue-700 px-3 py-1 rounded-full text-sm font-medium border border-blue-200 shadow-sm">
                    {course.category}
                  </span>
                </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg mb-8 border border-gray-100">
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center shadow-md">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {course.tags.map((tag) => (
                    <span
                      key={tag}
                      className="bg-blue-50 text-blue-700 px-3 py-2 rounded-lg text-sm font-medium border border-blue-200 shadow-sm"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 sticky top-24 border border-gray-100">
                ...
                {isEnrolled && enrollment && (
                  <div className="mb-6">
                    ...
                    {enrollment.completedAt && (
                      <div className="flex items-center space-x-2 mt-4 p-3 bg-green-50 rounded-lg border border-green-200 shadow-sm">
                ...
                {!isEnrolled && state.auth.user?.role !== 'instructor' && (
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 rounded-xl font-bold text-lg hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl mb-6"
                  >
                    Enroll Now
                  </button>
                )}
                ...
                {isEnrolled && (
                  <button className="w-full bg-green-100 text-green-700 py-4 rounded-xl font-bold text-lg border border-green-200 shadow-sm mb-6 cursor-default">
