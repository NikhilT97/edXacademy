          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                Join thousands of learners on edXacademy and unlock your potential with our comprehensive 
                courses in web development, AI, data science, and more.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  onClick={() => setCurrentView('courses')}
                  className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-medium hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl text-lg"
                >
                  Explore Courses
                </button>
                <button className="bg-white text-gray-700 px-8 py-4 rounded-xl font-medium hover:bg-gray-50 border border-gray-200 hover:border-blue-300 transition-all duration-300 text-lg shadow-sm">
                  Learn More
                </button>
              </div>
            </div>
        ...
        <div className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-800 mb-4">Why Choose edXacademy?</h2>
        ...
        <div className="py-20 bg-gradient-to-r from-blue-50 to-purple-50">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl text-gray-600">Start your learning journey today</p>
            </div>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {state.courses.slice(0, 3).map((course) => (
                <div key={course.id} className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden">
                  <img
                    src={course.image}
                    alt={course.title}
            ...
            <div className="text-center mt-12">
              <button
                onClick={() => setCurrentView('courses')}
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-medium hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                View All Courses
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => {
            ...
            return (
              <div
                key={index}
                className={`bg-white p-6 rounded-2xl shadow-md hover:shadow-lg border ${getStatColorClasses(stat.color)} transform hover:-translate-y-2 transition-all duration-300`}
              >
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <div className={`p-3 rounded-xl ${getIconColorClasses(stat.color)}`}>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="space-y-4">
                {userCourses.slice(0, 3).map((course) => {
                  ...
                  return (
                    <div key={course.id} className="flex items-center space-x-4 p-4 rounded-xl border border-gray-200 hover:bg-gray-50 transition-colors duration-200">
                      <img
                        src={course.image}
                        alt={course.title}
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className={`flex items-center space-x-4 p-4 rounded-xl ${achievement.earned ? 'bg-green-50 border border-green-200' : 'bg-gray-50 border border-gray-200'}`}>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <button
                  ...
                  className="flex items-center justify-center space-x-3 p-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-300"
                >
                ...
                <button
                  onClick={() => setCurrentView('courses')}
                  className="flex items-center justify-center space-x-3 p-6 border border-blue-200 text-blue-600 rounded-xl hover:bg-blue-50 transition-all duration-300"
                >
                  <Users className="h-6 w-6" />
                  <span className="font-medium">Manage Courses</span>
                </button>
                <button className="flex items-center justify-center space-x-3 p-6 border border-gray-200 text-gray-600 rounded-xl hover:bg-gray-50 transition-all duration-300">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {state.courses.filter(c => c.instructorId === state.auth.user?.id).slice(0, 3).map((course) => (
                  <div key={course.id} className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300">
                    <img
                      src={course.image}
                      alt={course.title}
